      ...
      <table class="table table-bordered table-hover align-middle">
        ...
        <tbody>
          <tr>
            ...
            <td class="text-center">
              <a href="edit_news.php?id=1" class="btn btn-warning btn-sm me-2" title="Edit">
                <i class="bi bi-pencil-square"></i>
              </a>
              <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal1" title="Delete">
