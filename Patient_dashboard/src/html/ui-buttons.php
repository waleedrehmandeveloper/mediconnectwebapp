...
<body>
  ...
  <div class="container bg-white p-4 rounded shadow profile-content">
    ...
    <div class="row mb-3">
      ...
      <div class="col-md-8 info-value">John Doe</div>
    </div>
    <div class="row mb-3">
      <div class="col-md-4 info-label">Contact Number:</div>
      <div class="col-md-8 info-value">0300-1234567</div>
    </div>
    <div class="row mb-3">
      <div class="col-md-4 info-label">Email:</div>
      <div class="col-md-8 info-value">johndoe@example.com</div>
    </div>
    <div class="row mb-3">
      <div class="col-md-4 info-label">Gender:</div>
      <div class="col-md-8 info-value">Male</div>
    </div>
    <div class="row mb-3">
      <div class="col-md-4 info-label">City:</div>
      <div class="col-md-8 info-value">Lahore</div>
    </div>
    <div class="row mb-3">
