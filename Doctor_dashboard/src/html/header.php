...
if (isset($_SESSION['doctor_id']) && !empty($_SESSION['doctor_id'])) {
    ...
    $query = "SELECT profile_pic FROM doctor_register WHERE id = $doctorid";
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          ...
          <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
            ...
            <div class="profile-container">
              <img src="imagedata/<?php echo $profileImg['profile_pic']; ?>" alt="Profile" class="profile-img">
            </div>
          </a>
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                  <div class="message-body">
                    <a href="javascript:void(0)" class="d-flex align-items-center gap-2 dropdown-item">
                      ...
                      <p class="mb-0 fs-3"><?php echo $doctor_name ?></p>
                    </a>
                  </div>
                </div>
              </li>
